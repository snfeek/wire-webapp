...
class CoreCrypto {
  constructor({wasmModule, path, key, clientId}) {
    ...
    __classPrivateFieldSet(
      this,
      _CoreCrypto_cc,
      __classPrivateFieldGet(this, _CoreCrypto_module, 'f').instance.exports.init_with_path_and_key(
        path,
        key,
        clientId,
      ),
    ...
    __classPrivateFieldSet(
      this,
      _CoreCrypto_ccFFI,
      __classPrivateFieldGet(this, _CoreCrypto_module, 'f').instance.exports,
      'f',
    );
  }
  ...
  createConversation(conversationId, {extraMembers, admins, ciphersuite, keyRotationSpan}) {
    return __classPrivateFieldGet(this, _CoreCrypto_ccFFI, 'f').cc_create_conversation(
      __classPrivateFieldGet(this, _CoreCrypto_cc, 'f'),
      conversationId,
      {
  ...
  decryptMessage(conversationId, payload) {
    return __classPrivateFieldGet(this, _CoreCrypto_ccFFI, 'f').cc_decrypt_message(
      __classPrivateFieldGet(this, _CoreCrypto_cc, 'f'),
      conversationId,
      payload,
    );
  ...
  encryptMessage(conversationId, message) {
    return __classPrivateFieldGet(this, _CoreCrypto_ccFFI, 'f').cc_encrypt_message(
      __classPrivateFieldGet(this, _CoreCrypto_cc, 'f'),
      conversationId,
      message,
    );
  ...
  processWelcomeMessage(welcomeMessage, {extraMembers, admins, ciphersuite, keyRotationSpan}) {
    return __classPrivateFieldGet(this, _CoreCrypto_ccFFI, 'f').cc_process_welcome_message(
      __classPrivateFieldGet(this, _CoreCrypto_cc, 'f'),
      welcomeMessage,
      {
        extra_members: extraMembers !== null && extraMembers !== void 0 ? extraMembers : [],
  ...
  clientPublicKey() {
    return __classPrivateFieldGet(this, _CoreCrypto_ccFFI, 'f').cc_client_public_key(
      __classPrivateFieldGet(this, _CoreCrypto_cc, 'f'),
    );
  }
  clientKeypackages(amountRequested) {
    return __classPrivateFieldGet(this, _CoreCrypto_ccFFI, 'f').cc_client_keypackages(
      __classPrivateFieldGet(this, _CoreCrypto_cc, 'f'),
      amountRequested,
    );
  }
  addClientsToConverastion(conversationId, clients) {
    return __classPrivateFieldGet(this, _CoreCrypto_ccFFI, 'f').cc_add_clients_to_conversation(
      __classPrivateFieldGet(this, _CoreCrypto_cc, 'f'),
      conversationId,
      clients,
    );
  ...
  removeClientsFromConversation(conversationId, clients) {
    return __classPrivateFieldGet(this, _CoreCrypto_ccFFI, 'f').cc_remove_clients_from_conversation(
      __classPrivateFieldGet(this, _CoreCrypto_cc, 'f'),
      conversationId,
      clients,
    );
  ...
  conversationExists(conversationId) {
    return __classPrivateFieldGet(this, _CoreCrypto_ccFFI, 'f').cc_conversation_exists(
      __classPrivateFieldGet(this, _CoreCrypto_cc, 'f'),
      conversationId,
    );
  }
